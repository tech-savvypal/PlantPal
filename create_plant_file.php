...
if (!$data || !isset($data['plantName'])) {
    http_response_code(400);
    echo "No plant name provided.";
    exit;
}

$plantName = preg_replace("/[^a-zA-Z0-9]/", "", $data['plantName']);
$escapedPlantName = htmlspecialchars($data['plantName'], ENT_QUOTES, 'UTF-8');
$filename = "$plantName.php";

// HTML + PHP template to show matching data
$template = <<<EOD
<?php
...
echo "<br><a href='index.html'>← Back to search</a>";
